...
cp -R emacs-interaction.scm gimp-mode.el gimp-install.el gimp-init.el gimpmode.pdf related INSTALL COPYING ChangeLog fud.el fud.scm gimp-mode-v$VERSION
